<?php include "inc/header.php";?>
 ...
 <h3>Technical Helper Creation</h3>
...
<div class="form-group">
   ...
   <select class="custom-select">
  <option selected>Select From Leader</option>
  <option value="1">Rasid</option>
  <option value="2">Akram</option>
  <option value="3">Hrittik</option>
</select>
</div>
<div class="form-group">
    <label>Foreman Name</label>
   <select class="custom-select">
  <option selected>Select From Foreman</option>
  <option value="1">Rasid</option>
  <option value="2">Akram</option>
  <option value="3">Hrittik</option>
</select>
